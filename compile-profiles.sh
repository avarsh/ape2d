...
then
  ...
  g++ --std=c++14 -pg $input_file deps/glad/glad.c \
  ...
  src/ape/graphics/shader.cpp src/ape/graphics/window.cpp src/ape/ape.cpp \
  src/ape/graphics/detail/graphics_detail.cpp \
  src/ape/graphics/detail/texture_store_detail.cpp \
  src/ape/graphics/texture_store.cpp src/ape/graphics/texture.cpp \
  src/ape/graphics/sprite.cpp src/ape/graphics/renderer.cpp \
